        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 mb-30">
                    ...
                    <div class="section-title mb-0">Sonali Jani <span>North East</span></div>
                    ...
                    <div class="tour-page head-icon">
                        ...
                        <p><i class="ti-location-pin"></i> North East</p>
                    ...
                    <ul class="list-unstyled page-list mb-30">
                        <li>
                            ...
                            <div class="page-list-text">
                                <p>4 Days 5 Nights, Group: 5 - 10 People, North East</p>
                            </div>
                        </li>
                    </ul>
