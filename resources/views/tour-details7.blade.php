        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 mb-30">
                    ...
                    <div class="section-title mb-0">Sonali Jani <span>Uttarakhand</span></div>
                    ...
                    <div class="tour-page head-icon">
                        <p><i class="ti-time"></i> 7 Days 6 Nights</p>
                        <p><i class="ti-user"></i> Group: 5 - 10 People</p>
                        <p><i class="ti-location-pin"></i> Uttarakhand</p>
                    ...
                    <ul class="list-unstyled page-list mb-30">
                        <li>
                            ...
                            <div class="page-list-text">
                                <p>5 Days 4 Nights, Group: 5 - 10 People, Uttarakhand</p>
                            </div>
                        </li>
                    </ul>
